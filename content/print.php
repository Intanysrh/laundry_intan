...
$queryPrint = mysqli_query($koneksi, "SELECT trans_order.id, trans_order.order_code, type_of_service.service_name, type_of_service.price, customer.customer_name, trans_order_detail.* FROM trans_order_detail 
