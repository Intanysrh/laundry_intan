    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/ui-buttons.html" aria-expanded="false">
                        <i class="ti ti-layers-subtract"></i>
                        <span class="hide-menu">Buttons</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/ui-alerts.html" aria-expanded="false">
                        <i class="ti ti-alert-circle"></i>
                        <span class="hide-menu">Alerts</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/ui-card.html" aria-expanded="false">
                        <i class="ti ti-cards"></i>
                        <span class="hide-menu">Card</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/ui-forms.html" aria-expanded="false">
                        <i class="ti ti-file-text"></i>
                        <span class="hide-menu">Forms</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/ui-typography.html" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/authentication-login.html" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/authentication-register.html" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/icon-tabler.html" aria-expanded="false">
                        <i class="ti ti-archive"></i>
                        <span class="hide-menu">Tabler Icon</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="template/sample-page.html" aria-expanded="false">
